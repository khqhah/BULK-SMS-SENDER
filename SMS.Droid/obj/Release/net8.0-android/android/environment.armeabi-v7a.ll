...
@dso_cache = dso_local local_unnamed_addr global [954 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 335136182, ; hash 0x13f9c5b6, from name: libaot-SMS.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 408655774, ; hash 0x185b979e, from name: SMS.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SMS.dll.so
		ptr null; void* handle (0x0)
	}, ; 90
	...
	%struct.DSOCacheEntry {
		i64 1100532246, ; hash 0x4198ca16, from name: aot-SMS.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SMS.dll.so
		ptr null; void* handle (0x0)
	}, ; 220
	...
	%struct.DSOCacheEntry {
		i64 1275290235, ; hash 0x4c03627b, from name: SMS
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SMS.dll.so
		ptr null; void* handle (0x0)
	}, ; 255
	...
	%struct.DSOCacheEntry {
		i64 2167360092, ; hash 0x812f4a5c, from name: libaot-SMS.Droid.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2185286180, ; hash 0x8240d224, from name: SMS.Droid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SMS.Droid.dll.so
		ptr null; void* handle (0x0)
	}, ; 473
	...
	%struct.DSOCacheEntry {
		i64 2564969827, ; hash 0x98e25563, from name: aot-SMS.Droid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SMS.Droid.dll.so
		ptr null; void* handle (0x0)
	}, ; 560
	...
	%struct.DSOCacheEntry {
		i64 2910252015, ; hash 0xad76ebef, from name: libaot-SMS
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SMS.dll.so
		ptr null; void* handle (0x0)
	}, ; 646
	...
	%struct.DSOCacheEntry {
		i64 3313789824, ; hash 0xc5846b80, from name: libaot-SMS.Droid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SMS.Droid.dll.so
		ptr null; void* handle (0x0)
	}, ; 738
	...
	%struct.DSOCacheEntry {
		i64 3571794311, ; hash 0xd4e54187, from name: aot-SMS
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SMS.dll.so
		ptr null; void* handle (0x0)
	}, ; 791
	...
	%struct.DSOCacheEntry {
		i64 3867980602, ; hash 0xe68cb33a, from name: SMS.Droid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SMS.Droid.dll.so
		ptr null; void* handle (0x0)
	}, ; 850
	...
	%struct.DSOCacheEntry {
		i64 4294276904, ; hash 0xfff57728, from name: aot-SMS.Droid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SMS.Droid.dll.so
		ptr null; void* handle (0x0)
	}, ; 952
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [199 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
